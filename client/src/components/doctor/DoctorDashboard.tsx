...
import { Calendar, CalendarDays, Clock, Users, Hourglass, ClipboardList, Sun, User, Cog, CheckCircle2 } from "lucide-react";
      ...
      <div className="max-w-5xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-3xl p-5 border border-sky-100 shadow-sm">
            <div className="w-10 h-10 bg-sky-50 rounded-2xl flex items-center justify-center mb-3"><CalendarDays className="h-5 w-5 text-sky-500" /></div>
          ...
          <div className="bg-white rounded-3xl p-5 border border-sky-100 shadow-sm">
            <div className="w-10 h-10 bg-amber-50 rounded-2xl flex items-center justify-center mb-3"><Hourglass className="h-5 w-5 text-amber-500" /></div>
          ...
          <div className="bg-white rounded-3xl p-5 border border-sky-100 shadow-sm">
            <div className="w-10 h-10 bg-sky-50 rounded-2xl flex items-center justify-center mb-3"><Users className="h-5 w-5 text-sky-500" /></div>
          ...
          <div className="lg:col-span-2 space-y-6">
            <div className="bg-white rounded-3xl border border-sky-100 shadow-sm overflow-hidden">
              <div className="px-6 py-5 border-b border-sky-50 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-sky-50 rounded-xl flex items-center justify-center"><ClipboardList className="h-4 w-4 text-sky-500" /></div>
                  <h2 className="font-bold text-[#2E3A59] text-lg">Today's Schedule</h2>
                </div>
                <Link href="/doctor/schedule">
                  <span className="text-xs text-sky-500 hover:text-sky-600 font-semibold transition-colors">
                    Full schedule →
                  </span>
                </Link>
              </div>
              ...
              {todaysAppointments.length > 0 ? (
                ...
                <div className="py-12 text-center">
                  <div className="text-4xl mb-3"><Sun className="h-12 w-12 text-amber-300 mx-auto" /></div>
            ...
            <div className="bg-white rounded-3xl border border-sky-100 shadow-sm overflow-hidden">
              <div className="px-6 py-5 border-b border-sky-50 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 bg-sky-50 rounded-xl flex items-center justify-center"><Users className="h-4 w-4 text-sky-500" /></div>
                    ...
                    <div key={appt.id} className="flex items-center gap-4 px-6 py-4 hover:bg-sky-50/40 transition-colors">
                      ...
                      <Link href={`/doctor/patient-records/${appt.patient.id}`}>
                        <button className="text-xs font-bold text-sky-500 hover:text-sky-700 px-3 py-1.5
                          rounded-xl border border-sky-100 hover:border-sky-300 hover:bg-sky-50 transition-all">
                          Records →
                        </button>
                      </Link>
                    </div>
              ...
              <div className="p-4 space-y-2">
                <Link href="/doctor/schedule">
                  <div className="flex items-center gap-3 p-3 rounded-2xl hover:bg-sky-50 transition-colors cursor-pointer group">
                    <div className="w-9 h-9 bg-sky-50 rounded-xl flex items-center justify-center group-hover:bg-sky-100 transition-colors"><CalendarDays className="h-4 w-4 text-sky-500" /></div>
                    <div>
                      <p className="font-semibold text-[#2E3A59] text-sm">My Schedule</p>
                      <p className="text-gray-400 text-xs">View & manage availability</p>
                    </div>
                ...
                <Link href="/doctor/patients">
                  <div className="flex items-center gap-3 p-3 rounded-2xl hover:bg-sky-50 transition-colors cursor-pointer group">
                    <div className="w-9 h-9 bg-sky-50 rounded-xl flex items-center justify-center group-hover:bg-sky-100 transition-colors"><Users className="h-4 w-4 text-sky-500" /></div>
                    <div>
                ...
                <Link href="/doctor/profile">
                  <div className="flex items-center gap-3 p-3 rounded-2xl hover:bg-sky-50 transition-colors cursor-pointer group">
                    <div className="w-9 h-9 bg-sky-50 rounded-xl flex items-center justify-center group-hover:bg-sky-100 transition-colors"><User className="h-4 w-4 text-sky-500" /></div>
                    <div>
                ...
                <Link href="/doctor/settings">
                  <div className="flex items-center gap-3 p-3 rounded-2xl hover:bg-sky-50 transition-colors cursor-pointer group">
                    <div className="w-9 h-9 bg-sky-50 rounded-xl flex items-center justify-center group-hover:bg-sky-100 transition-colors"><Cog className="h-4 w-4 text-sky-500" /></div>
                    <div>
